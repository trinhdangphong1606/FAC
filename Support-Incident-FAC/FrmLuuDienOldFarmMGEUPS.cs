...
{
    public partial class FrmLuuDienOldFarmMGEUPS : Form
    {
        public FrmLuuDienOldFarmMGEUPS()
        {
            InitializeComponent();
        }
        ...
        private void Btn3UPS_Click(object sender, EventArgs e)
        {
            LbNoiDungMail.Text = "Hiện tại đang có Incident Level 1 : 3 UPS bị hư ";
            LBCacheNoiDung.Text = "Hiện tại đang có Incident Level 1 : 3 UPS bị hư ";
        ...
        {
            LbNoiDungMail.Text = "Hiện tại đang có Incident Level 1 : 02÷08 STS/PMM bị hư ";
            LBCacheNoiDung.Text = "Hiện tại đang có Incident Level 1 : 02÷08 STS/PMM bị hư ";

        }

        private void Btn1SW_Click(object sender, EventArgs e)
        {
            LbNoiDungMail.Text = "Hiện tại đang có Incident Level 3 : 1 SW bị hư ";
            LBCacheNoiDung.Text = "Hiện tại đang có Incident Level 3 : 1 SW bị hư ";

        }

        private void Btn2SW_Click(object sender, EventArgs e)
        {
            LbNoiDungMail.Text = "Hiện tại đang có Incident Level 4 : 2/3 SW bị hư ";
            LBCacheNoiDung.Text = "Hiện tại đang có Incident Level 4 : 2/3 SW bị hư ";
