...
{
    public partial class FrmMayLanhTrungTamChiller : Form
    {
        public FrmMayLanhTrungTamChiller()
        {
            InitializeComponent();
        }

        //--------------- Lỗi hệ thống máy phát điện ---------------------
        private void Btn1ChillerHu_Click(object sender, EventArgs e)
        {
            LbNoiDungMail.Text = "Hiện tại đang có Incident Level 3 : 1 Chiller bị hư ";
            LBCacheNoiDung.Text = "Hiện tại đang có Incident Level 3 : 1 Chiller bị hư ";

        }

        private void Btn2ChillerHu_Click(object sender, EventArgs e)
        {
            LbNoiDungMail.Text = "Hiện tại đang có Incident Level 1 : 2 Chiller bị hư ";
            LBCacheNoiDung.Text = "Hiện tại đang có Incident Level 1 : 2 Chiller bị hư ";

        }

        private void BtnTĐHuToanPhan_Click(object sender, EventArgs e)
        {
            LbNoiDungMail.Text = "Hiện tại đang có Incident Level 1 : Tủ điện ĐK hệ thống chiller hư toàn phần ";
            LBCacheNoiDung.Text = "Hiện tại đang có Incident Level 1 : Tủ điện ĐK hệ thống chiller hư toàn phần ";

        }

        private void BtnTĐHu1BienTan_Click(object sender, EventArgs e)
        {
            LbNoiDungMail.Text = "Hiện tại đang có Incident Level 3 : Tủ điện ĐK hệ thống chiller hư 1 biến tần ";
            LBCacheNoiDung.Text = "Hiện tại đang có Incident Level 3 : Tủ điện ĐK hệ thống chiller hư 1 biến tần ";

        }

        private void BtnVoDuongOng_Click(object sender, EventArgs e)
        {
            LbNoiDungMail.Text = "Hiện tại đang có Incident Level 1 : Vỡ đường ống hệ thống chiller ";
            LBCacheNoiDung.Text = "Hiện tại đang có Incident Level 1 : Vỡ đường ống hệ thống chiller ";

        }

        private void BtnXiDuongOng_Click(object sender, EventArgs e)
        {
            LbNoiDungMail.Text = "Hiện tại đang có Incident Level 3 : Xì đường ống, van hệ thống chiller ";
            LBCacheNoiDung.Text = "Hiện tại đang có Incident Level 3 : Xì đường ống, van hệ thống chiller ";

        }

        private void BtnHuCPC_Click(object sender, EventArgs e)
        {
            LbNoiDungMail.Text = "Hiện tại đang có Incident Level 4 : Hư CPC System hệ thống chiller ";
            LBCacheNoiDung.Text = "Hiện tại đang có Incident Level 4 : Hư CPC System hệ thống chiller ";

        }

        private void BtnBeNuocCap_Click(object sender, EventArgs e)
        {
            LbNoiDungMail.Text = "Hiện tại đang có Incident Level 3 : Hệ thống Chiller bị bể 80m3 còn 30% nước ";
            LBCacheNoiDung.Text = "Hiện tại đang có Incident Level 3 : Hệ thống Chiller bị bể 80m3 còn 30% nước ";

        }

        private void BtnCupNuoc_Click(object sender, EventArgs e)
        {
            LbNoiDungMail.Text = "Hiện tại đang có Incident Level 4 : QTSC cúp nước ";
            LBCacheNoiDung.Text = "Hiện tại đang có Incident Level 4 : QTSC cúp nước ";

        }
        private void BtnChayLon_Click(object sender, EventArgs e)
        {
            LbNoiDungMail.Text = "Hiện tại đang có Incident Level 1 : Máy phát điện Genset đang cháy lớn";
            LBCacheNoiDung.Text = "Hiện tại đang có Incident Level 1 : Máy phát điện Genset đang cháy lớn";

        }
        private void BtnChayNho_Click(object sender, EventArgs e)
        {
            LbNoiDungMail.Text = "Hiện tại đang có Incident Level 3 : Máy phát điện Genset đang cháy nhỏ";
            LBCacheNoiDung.Text = "Hiện tại đang có Incident Level 3 : Máy phát điện Genset đang cháy nhỏ";

        }
        //--------------- End Lỗi hệ thống máy phát điện ----------------
        // ----------------------Title --------------------------------
