...
{
    public partial class FrmMayPhatDienGenSet : Form
    {
        public FrmMayPhatDienGenSet()
        {
            InitializeComponent();
        }
        //--------------- Lỗi hệ thống máy phát điện ---------------------
        private void Btn1MayPhatDienHu_Click(object sender, EventArgs e)
        {
            LbNoiDungMail.Text = "Hiện tại đang có Incident Level 3 : 1 Máy phát điện GenSet bị hư";
            LBCacheNoiDung.Text = "Hiện tại đang có Incident Level 3 : 1 Máy phát điện GenSet bị hư";
        }
        private void Btn2MayPhatDienHu_Click(object sender, EventArgs e)
        {
            LbNoiDungMail.Text = "Hiện tại đang có Incident Level 2 : 2 Máy phát điện GenSet bị hư ";
            LBCacheNoiDung.Text = "Hiện tại đang có Incident Level 2 : 2 Máy phát điện GenSet bị hư ";
        }
        private void Btn3MayPhatDienHu_Click(object sender, EventArgs e)
        {
            LbNoiDungMail.Text = "Hiện tại đang có Incident Level 1 : 3 Máy phát điện GenSet bị hư";
            LBCacheNoiDung.Text = "Hiện tại đang có Incident Level 1 : 3 Máy phát điện GenSet bị hư";
        }
        private void BtnXiOngBonTrongPhong_Click(object sender, EventArgs e)
        {
            LbNoiDungMail.Text = "Hiện tại đang có Incident Level 3 : Xì ống/bồn (pump dầu và đường ống) trong phòng";
            LBCacheNoiDung.Text = "Hiện tại đang có Incident Level 3 : Xì ống/bồn (pump dầu và đường ống) trong phòng";

        }
        private void BtnXiOngBonNgoaiTroi_Click(object sender, EventArgs e)
        {
            LbNoiDungMail.Text = "Hiện tại đang có Incident Level 4 : Xì ống/bồn (pump dầu và đường ống) ngoài trời";
            LBCacheNoiDung.Text = "Hiện tại đang có Incident Level 4 : Xì ống/bồn (pump dầu và đường ống) ngoài trời";

        }
        private void BtnBusbartuhoa_Click(object sender, EventArgs e)
        {
            LbNoiDungMail.Text = "Hiện tại đang có Incident Level 1 : Busbar tủ hòa bị hư";
            LBCacheNoiDung.Text = "Hiện tại đang có Incident Level 1 : Busbar tủ hòa bị hư";
